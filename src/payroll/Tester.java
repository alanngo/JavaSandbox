...
import payroll.resource.*;

/**
 * Instructions:
 *
 * Follow the class diagram strictly. Read the problem statement, functionality and the other details
 ...
 * getContractIdCounter, setContractIdCounter, getPermenantIdCounter and setPermenantIdCounter in Employee class are
 * static methods.
...
public class Tester
{
    public static void main(String[] args)
    {
        ...
        try {
            permanentEmployee1 = new PermanentEmployee("Roger Fed", 15500.0, new String[]
                    {"DA-50","HRA-40"}, new Asset[] {asset1, asset10});
            permanentEmployee2 = new PermanentEmployee("Serena W", 14000.0, new String[]
                    {"DA-40","HRA-40"}, new Asset[] {asset6, asset9});
            permanentEmployee3 = new PermanentEmployee("James Peter", 18500.0, new String[]
                    {"DA-50","HRA-45"}, new Asset[] {asset4});
            permanentEmployee4 = new PermanentEmployee("Catherine Maria", 20000.0, new String[]
                    {"DA-50","HRA-45"}, new Asset[] {asset2, asset5});
            permanentEmployee5 = new PermanentEmployee("Jobin Nick", 21000.0, new String[]
                    {"DA-50","HRA-50"}, null);
